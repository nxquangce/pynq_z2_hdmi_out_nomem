...
#
# .tcl: Tcl script for re-creating project 'pynq_z2_hdmi_out_nomem'
#
# Generated by Vivado on Mon Dec 14 02:17:54 +07 2020
...
#
#    ".../pynq_z2_hdmi_out_nomem/src/address_generator.v"
#    ".../pynq_z2_hdmi_out_nomem/pynq_z2_hdmi_out_nomem.srcs/sources_1/bd/video_out_pynq_z2/hdl/video_out_pynq_z2_wrapper.v"
#    ".../pynq_z2_hdmi_out_nomem/src/video_pattern_generator.v"
#    ".../pynq_z2_hdmi_out_nomem/src/top.v"
#    ".../pynq_z2_hdmi_out_nomem/pynq_z2_hdmi_out_nomem.srcs/constrs_1/imports/constr/pynq-z2_v1.0.xdc"
#
...
set _xil_proj_name_ "pynq_z2_hdmi_out_nomem"
...
# address_generator
  ...
  set clk_100M [ create_bd_port -dir O clk_100M ]
  set col_address [ create_bd_port -dir O -from 10 -to 0 col_address ]
  set data_in [ create_bd_port -dir I -from 23 -to 0 -type data data_in ]
  set next_pixel [ create_bd_port -dir O next_pixel ]
  set row_address [ create_bd_port -dir O -from 9 -to 0 row_address ]
  ...
  connect_bd_net -net Net [get_bd_pins address_generator_0/valid] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tvalid] [get_bd_pins v_tpg_0/m_axis_video_TVALID]
  connect_bd_net -net Net1 [get_bd_pins address_generator_0/ready] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tready] [get_bd_pins v_tpg_0/m_axis_video_TREADY]
  connect_bd_net -net address_generator_0_col [get_bd_ports col_address] [get_bd_pins address_generator_0/col]
  connect_bd_net -net address_generator_0_next_pixel [get_bd_ports next_pixel] [get_bd_pins address_generator_0/next_pixel]
  connect_bd_net -net address_generator_0_row [get_bd_ports row_address] [get_bd_pins address_generator_0/row]
  connect_bd_net -net data_in_1 [get_bd_ports data_in] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tdata]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports clk_100M] [get_bd_pins address_generator_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rgb2dvi_1/PixelClk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_tpg_0/ap_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rgb2dvi_1_TMDS_Clk_n [get_bd_ports TMDS_Clk_n_0] [get_bd_pins rgb2dvi_1/TMDS_Clk_n]
  connect_bd_net -net rgb2dvi_1_TMDS_Clk_p [get_bd_ports TMDS_Clk_p_0] [get_bd_pins rgb2dvi_1/TMDS_Clk_p]
  connect_bd_net -net rgb2dvi_1_TMDS_Data_n [get_bd_ports TMDS_Data_n_0] [get_bd_pins rgb2dvi_1/TMDS_Data_n]
  connect_bd_net -net rgb2dvi_1_TMDS_Data_p [get_bd_ports TMDS_Data_p_0] [get_bd_pins rgb2dvi_1/TMDS_Data_p]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tpg_0/ap_rst_n]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins v_tc_0/gen_clken]
  connect_bd_net -net v_tpg_0_m_axis_video_TLAST [get_bd_pins address_generator_0/eol] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tlast] [get_bd_pins v_tpg_0/m_axis_video_TLAST]
  connect_bd_net -net v_tpg_0_m_axis_video_TUSER [get_bd_pins address_generator_0/sof] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tuser] [get_bd_pins v_tpg_0/m_axis_video_TUSER]
...
set_property REGISTERED_WITH_MANAGER "1" [get_files video_out_pynq_z2.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files video_out_pynq_z2.bd ] 
